...
export function adjustObjects(scene, progressText) {
    ...
    return new Promise((resolve) => {
        ...
        // MAN
        let man = scene.getObjectByName("Armature002");
        // man.position.y = 
        man.traverse((child) => {

            //change the material of child to mesh basic, with same texture and cast shadow
            if (child.isMesh) {
...
export function adjustAnimations(scene) {
