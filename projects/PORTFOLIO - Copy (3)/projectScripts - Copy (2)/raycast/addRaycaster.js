...
export const goldInnerGlowMatSkinned = CONSTANTS.createInnerGlow(undefined, { skinned: true, power: 1.5, intensity: 1, side: THREE.BackSide });
...
export class Raycaster {
    constructor(scene, camera, renderer, size = 32) {
        ...
        informerText.style.textAlign = 'center'; // Center align multiline text
        informerText.style.whiteSpace = 'pre-line'; // Allow \n to break lines
