...
// Usage example:
// import { BasicGeometries } from './setupBasicGeometries.js';
// const mesh = new THREE.Mesh(BasicGeometries.box, material);
// mesh.scale.set(2, 2, 2); // for a 2x2x2 box
