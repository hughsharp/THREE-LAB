...
let raycaster;
let pointsApp;
// let instancedGrid; // Removed inline reference
...
import { CubeGrid } from './projectScripts/points/points-cube.js';
...
async function init() {
    ...
    // Initialize the CubeGrid app
    cubeGridApp = new CubeGrid(scene, camera);
