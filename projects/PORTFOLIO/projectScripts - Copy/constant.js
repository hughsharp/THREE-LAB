...
export const stormFS = `
  ...
  vec3 render(vec2 uv) {
      ...
      vec3 auraColor = vec3(0.6, 0.8, 1.0) * uMoonBrightness * 0.5;
...
export function createOscillatingInnerGlowMat(glowColor, glowPower, glowIntensity, oscillationStrength = 1.0) {
  return new THREE.ShaderMaterial({
    uniforms: {
      glowColor: { value: new THREE.Color(glowColor) },
      glowPower: { value: glowPower },
...
export const goldOscillatingMat = createOscillatingInnerGlowMat("#FBC189", 1., 1., 0.1);
export const goldOscillatingOuterGlowMat = createOscillatingOuterGlowMat("#FBC189", 1, 0.01, 6.5, THREE.FrontSide) 