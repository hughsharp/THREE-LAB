...
export const groundVortexFS2 = `
    uniform float iTime;
    uniform sampler2D iChannel0;
    uniform sampler2D iChannel1;
    uniform vec2 iResolution;
    uniform vec2 iMouse;
    uniform float globalProgressor;
...
void main()
{
    ...
    float border = 0.25;
    vec2 bl = smoothstep(0., border, 1.+uv); // bottom left
    ...
    float a = length(color) > 1.7? 1. : length(color);
